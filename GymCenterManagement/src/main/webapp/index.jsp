...
<body>
        ...
        <nav class="container py-3">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="home-actions d-flex align-items-center gap-2 flex-wrap justify-content-end">
                    ...
                    <a href="#dang-ky-pt" class="btn btn-dark">
                        <i class="fa fa-user-tie me-1"></i>Đăng ký trở thành PT
                    </a>
                </div>
            </div>
        </nav>
    ...
    <main>
        ...
        <section id="goi-tap" class="section-space">
            <div class="container">
                <div class="section-heading">
                    ...
                    <p>Các gói bên dưới là gợi ý hiển thị cho trang chủ; nhân viên phòng tập sẽ hỗ trợ đăng ký chi tiết theo dữ liệu hiện có trong hệ thống.</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="package-card">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge bg-light text-primary border">1 tháng</span>
                            </div>
                            <div class="package-price">399K</div>
                            <p class="muted-copy">Phù hợp để bắt đầu làm quen với không gian và thiết bị.</p>
                            <ul class="package-list">
                                <li><i class="fa fa-check"></i><span>Vào phòng tập trong giờ hoạt động</span></li>
                                <li><i class="fa fa-check"></i><span>Tư vấn khởi động ban đầu</span></li>
                                <li><i class="fa fa-check"></i><span>Hỗ trợ theo dõi hồ sơ hội viên</span></li>
                            </ul>
                            <a href="${pageContext.request.contextPath}/register" class="btn btn-outline-primary mt-auto">Đăng ký thành viên</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="package-card border-primary shadow-sm">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h4 class="fw-bold mb-0">Nâng cao</h4>
                                <span class="badge bg-primary">3 tháng</span>
                            </div>
                            <div class="package-price">999K</div>
                            <p class="muted-copy">Lựa chọn cân bằng cho người muốn duy trì lịch tập ổn định.</p>
                            <ul class="package-list">
                                <li><i class="fa fa-check"></i><span>Ưu tiên tư vấn lịch tập theo mục tiêu</span></li>
                                <li><i class="fa fa-check"></i><span>Theo dõi tiến độ định kỳ</span></li>
                                <li><i class="fa fa-check"></i><span>Gợi ý kết hợp cùng dịch vụ PT</span></li>
                            </ul>
                            <a href="${pageContext.request.contextPath}/register" class="btn btn-primary mt-auto">Chọn gói này</a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="package-card">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h4 class="fw-bold mb-0">Cam kết</h4>
                                <span class="badge bg-light text-primary border">6 tháng</span>
                            </div>
                            <div class="package-price">1.799K</div>
                            <p class="muted-copy">Dành cho người đã có mục tiêu dài hạn và muốn tối ưu chi phí.</p>
                            <ul class="package-list">
                                <li><i class="fa fa-check"></i><span>Định hướng tập luyện dài hạn</span></li>
                                <li><i class="fa fa-check"></i><span>Hỗ trợ điều chỉnh mục tiêu theo từng giai đoạn</span></li>
                                <li><i class="fa fa-check"></i><span>Ưu tiên nhận tư vấn từ đội ngũ PT</span></li>
                            </ul>
                            <a href="${pageContext.request.contextPath}/register" class="btn btn-outline-primary mt-auto">Đăng ký tư vấn</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="dang-ky-pt" class="join-band section-space">
            <div class="container">
                <div class="row align-items-center g-4">
                    <div class="col-lg-8">
                        <span class="badge bg-warning text-dark mb-3">Dành cho huấn luyện viên</span>
                        <h2 class="fw-bold mb-3">Muốn trở thành PT tại GCMS?</h2>
                        <p class="muted-copy mb-0">
                            Nếu bạn có chuyên môn huấn luyện, chứng chỉ phù hợp và mong muốn đồng hành cùng hội viên, hãy chuẩn bị hồ sơ cá nhân để đội ngũ phòng tập hỗ trợ tạo tài khoản PT.
                        </p>
                    </div>
                    <div class="col-lg-4 text-lg-end">
                        <a href="${pageContext.request.contextPath}/login" class="btn btn-light btn-lg px-4 me-lg-2 mb-2">
                            Đăng nhập hệ thống
                        </a>
                        <a href="#lien-he" class="btn btn-outline-light btn-lg px-4 mb-2">
                            Xem liên hệ
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-start">
                <div class="col-lg-5">
                    ...
                    <p class="mb-0">Không gian quản lý và tập luyện dành cho phòng gym hiện đại, rõ ràng và thân thiện với người dùng Việt.</p>
                </div>
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="#dang-ky-pt">Đăng ký trở thành PT</a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <h6 class="text-white fw-bold">Liên hệ phòng tập</h6>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-2 text-primary"></i>Quầy tư vấn GCMS</p>
                    <p class="mb-2"><i class="fa fa-phone me-2 text-primary"></i>0900 000 000</p>
                    <p class="mb-0"><i class="fa fa-envelope me-2 text-primary"></i>hotro@gcms.vn</p>
                </div>
            </div>
            <div class="border-top border-secondary mt-4 pt-4 d-flex flex-wrap justify-content-between gap-2">
