                    ...
                    <c:choose>
                        <c:when test="${role == 'Admin'}">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle ${(fn:contains(reqUri, '/admin/payment-history')|| fn:contains(reqUri, '/admin/work-history')) ? 'active' : ''}" data-bs-toggle="dropdown"> <i class="fa fa-history me-2"></i>Lịch sử</a>
                                <div class="dropdown-menu bg-transparent border-0 ${(fn:contains(reqUri, '/admin/payment-history') || fn:contains(reqUri, '/admin/work-history')) ? 'show' : ''}">
                                    <a href="${pageContext.request.contextPath}/admin/payment-history" class="dropdown-item ${fn:contains(reqUri, '/admin/payment-history') ? 'active' : ''}">Thanh toán</a>
                                    <a href="${pageContext.request.contextPath}/admin/work-history" class="dropdown-item ${fn:contains(reqUri, '/admin/work-history') ? 'active' : ''}">Điểm danh</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                            ...
                            <a href="${pageContext.request.contextPath}/pt/work-history" class="nav-item nav-link ${fn:contains(reqUri, '/pt/work-history') ? 'active' : ''}"><i class="fa fa-history me-2"></i>Lịch sử điểm danh</a>
                        </c:when>
