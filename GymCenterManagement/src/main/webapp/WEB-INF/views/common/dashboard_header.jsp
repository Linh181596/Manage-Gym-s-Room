                ...
                <div class="navbar-nav w-100">
                    ...
                    <c:choose>
                        <c:when test="${role == 'Admin'}">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/checkin" class="nav-item nav-link ${fn:contains(reqUri, '/admin/checkin') || fn:contains(reqUri, '/admin/work-history') ? 'active' : ''}"><i class="fa fa-clipboard-check me-2"></i>Điểm danh ra vào</a>
