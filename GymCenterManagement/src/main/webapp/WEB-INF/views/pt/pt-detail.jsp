    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm text-center p-4">
                ...
                <div class="mt-3">
                    ...
                    <% String avatarPath = trainer.getAvatarPath();
                ...
                <h4 class="text-dark fw-bold mb-1"><%= trainer.getPublicName() %>
                </h4>
                <p class="text-secondary small mb-3"><%= trainer.getEmail() != null ? trainer.getEmail() : "Email chưa cập nhật" %>
                </p>
                ...
                <ul class="list-group list-group-flush text-start small mb-3">
                    <li class="list-group-item d-flex justify-content-between px-0">
                        <span class="text-muted"><i
                                class="fa fa-calendar-alt me-1.5 text-secondary"></i>Kinh nghiệm:</span>
                ...
                <div class="p-3 bg-light rounded mt-2 text-start">
                    <h6 class="text-dark fw-bold mb-1"><i class="fa fa-certificate text-warning me-1.5"></i>Chứng chỉ đã
                        xác minh</h6>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm p-4 mb-4">
                <h5 class="text-dark fw-bold mb-3 border-bottom pb-2"><i
                        class="fa fa-address-card text-primary me-2"></i>Giới thiệu bản thân</h5>
            ...
            <div class="card border-0 shadow-sm p-4">
                <h5 class="text-dark fw-bold mb-3 border-bottom pb-2"><i class="fa fa-tags text-primary me-2"></i>Bảng
                    giá các gói tập với <%= trainer.getPublicName() %>
                </h5>

                <% if (servicePrices == null || servicePrices.isEmpty()) { %>
                <div class="text-center py-4 text-muted">
                    <i class="fa fa-box-open fa-2x mb-2 text-secondary"></i>
                    <p class="mb-0 small">Hiện HLV này chưa đăng ký biểu giá các gói tập cụ thể. Vui lòng liên hệ lễ tân
                ...
                <div class="row row-cols-1 row-cols-md-2 g-3">
                    ...
                    <div class="col">
                        <div class="border rounded p-3 h-100 d-flex flex-column hover-shadow transition-all bg-white position-relative">
                            ...
                            <h6 class="text-dark fw-bold mb-1 pe-5"><%= price.getPackageName() %>
                            </h6>
                            <p class="text-muted small mb-3 flex-grow-1"><%= price.getPackageDescription() %>
                            </p>
