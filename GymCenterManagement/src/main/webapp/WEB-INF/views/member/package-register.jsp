<%--
  ...
  Author      : (AI Generated)
  Description : Trang đăng ký gói tập dành cho Hội viên
  =========================================================================
--%>
...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="mb-4">
        <div>
            <h4 class="mb-0 text-dark fw-bold"><i class="fa fa-dumbbell me-2 text-primary"></i>Đăng ký gói tập Gym</h4>
            <small class="text-muted">Lựa chọn gói tập phù hợp và tiến hành thanh toán để kích hoạt</small>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-7 col-lg-8">
            <div class="bg-light rounded p-4 p-md-5 shadow-sm border-0 h-100">
                ...
                <form action="${pageContext.request.contextPath}/member/register-package" method="post" id="registrationForm" class="needs-validation" novalidate>
                    ...
                    <div class="d-flex gap-3 justify-content-end border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary px-5 shadow-sm">
                            Đăng ký & Thanh toán <i class="fa fa-arrow-right ms-2"></i>
                        </button>
                    </div>
                </form>
            </div>
