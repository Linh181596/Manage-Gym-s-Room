                    ...
                    <div class="bg-light rounded p-4 shadow-sm border border-white mb-4">
                        ...
                        <div class="mb-3 position-relative d-inline-block">
                            <img id="avatarPreview" 
                                 src="${(profile.roleName eq 'PT' and not empty profile.avatarPath) ? profile.avatarPath : 'https://cdnjs.cloudflare.com/ajax/libs/admin-lte/3.2.0/img/user2-160x160.jpg'}" 
                                        ...
                                        <div>
                                            <c:choose>
                                                <c:when test="${not empty profile.certificateFileName}">
                                                    ...
                                                    <a href="${profile.certificateFilePath}" target="_blank" class="text-decoration-none fw-bold text-primary">${profile.certificateFileName}</a>
                                                </c:when>
                                                <c:otherwise>
