...
import com.gcms.dao.ProfileDAO;
import com.gcms.dto.*;
import com.gcms.model.User; // Import thực thể User gốc để đồng bộ Session Key
import java.io.File;
...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        UserProfileBaseDTO profile = profileDAO.getUserProfileById(userId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String roleName = profileDAO.getHighestPriorityRole(userId);
        UserProfileBaseDTO currentProfile = profileDAO.getUserProfileById(userId);
        ...
        try {
            boolean isSuccess = profileDAO.updateUserProfile(currentProfile, roleName);
