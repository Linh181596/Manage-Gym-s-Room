 ...
 */
/*
    Class này đại diện cho profile của PT
    Lưu trữ các thông tin về PT, thông tin public, chứng chỉ, status
    Link tới user 

    Experience years = current - careerStartDate
...
public class PersonalTrainer {
     ...
     *
     * @return display name for public trainer screens
     */
     ...
     *
     * @return calculated number of experience years
     */
