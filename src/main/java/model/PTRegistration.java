 ...
 */
/**
 * Represents a member's Personal Trainer service registration. A registration
 * is created with Pending status after a member submits a PT service
 * registration request. Staff/Admin later processes payment and arranges
