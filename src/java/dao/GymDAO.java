...
public class GymDAO {
    ...
    // ĐÃ SỬA: Đảm bảo cập nhật xóa mềm IsDeleted = 1 đồng bộ cho cả Users và Members thông qua UserID
    ...
    // ĐÃ SỬA: Loại bỏ ép buộc gắt gao mp.Status = 'Active' để tránh lỗi xem hồ sơ trống khi hội viên mới chưa active gói xong
